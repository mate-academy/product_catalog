...
1. Commit and push the code to `develop` branch on github.

## How to develop a feature

1. `Pull` the latest `develop`.
1. Create a `feat/your-feature-name` branch and `push` it to Github.
1. Open a Pull Request (`PR`) from your branch to the `develop`.
1. Add a DEMO LINK to the PR description.
...
1. Merge your PR after mentor's approve and delete the your branch.
